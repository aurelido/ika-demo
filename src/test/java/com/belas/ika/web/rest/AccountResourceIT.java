...
import com.belas.ika.repository.AuthorityRepository;
...
import com.belas.ika.service.dto.PasswordChangeDTO;
import com.belas.ika.web.rest.vm.KeyAndPasswordVM;
import com.belas.ika.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@ikadev.com");
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.email").value("john.doe@ikadev.com"))
