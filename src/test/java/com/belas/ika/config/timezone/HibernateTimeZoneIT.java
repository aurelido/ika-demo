package com.belas.ika.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.belas.ika.IntegrationTest;
import com.belas.ika.repository.timezone.DateTimeWrapper;
import com.belas.ika.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ika_date_time_wrapper where id=%d", fieldName, id);
    }
