package com.belas.ika.config.liquibase;
...
public class AsyncSpringLiquibase extends DataSourceClosingSpringLiquibase {
    ...
    private boolean isLiquibaseDisabled() {
        return env.acceptsProfiles(Profiles.of(IkaConstants.SPRING_PROFILE_NO_LIQUIBASE));
    }

    private boolean isAsyncProfileActive() {
        return env.acceptsProfiles(Profiles.of(IkaConstants.SPRING_PROFILE_DEVELOPMENT + "|" + IkaConstants.SPRING_PROFILE_HEROKU));
    }
